                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center">
                                    <form action="add_to_cart.jsp" method="post">
                                        <input type="hidden" name="product_name" value="Hotel Londres">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center">
                                    <form action="add_to_cart.jsp" method="post">
                                        <input type="hidden" name="product_name" value="Atlantis the Palm">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center">
                                    <form action="add_to_cart.jsp" method="post">
                                        <input type="hidden" name="product_name" value="The Plaza">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center">
                                    <form action="add_to_cart.jsp" method="post">
                                        <input type="hidden" name="product_name" value="Hotel Lutetia">
