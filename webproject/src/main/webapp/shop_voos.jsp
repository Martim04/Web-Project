...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js"></script>
    ...
    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
        ...
        %>
                <li><a class="dropdown-item" href="logins.jsp">Login</a></li>
        <%
            }
        } else {
        %>
        ...
        %>
        <li><a class="dropdown-item" href="logins.jsp">Logout</a></li>
    </ul>
</li>
                    </ul>
                </div>
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Reserve o seu Voo</h1>
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center">
                                    <form action="add_to_cart.jsp" method="post">
                                        <input type="hidden" name="product_name" value="Voo Londres">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center">
                                    <form action="add_to_cart.jsp" method="post">
                                        <input type="hidden" name="product_name" value="Voo Dubai">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Voo New York</h5>
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center">
                                    <form action="add_to_cart.jsp" method="post">
                                        <input type="hidden" name="product_name" value="Voo New York">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center">
                                    <form action="add_to_cart.jsp" method="post">
                                        <input type="hidden" name="product_name" value="Voo Paris">
